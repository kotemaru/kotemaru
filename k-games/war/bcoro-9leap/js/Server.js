...
(function(Class) {
	...
	Class.toUrl = function(fname){
		return CONTEXT_PATH+fname;
	}
	...
	Class.postScore = function(name, stage, time) {
		var url = "/bcoro/score/post?game=bcoro&stage="
	...
	Class.listScore = function(name, stage) {
		var url = "/bcoro/score/get?game=bcoro&stage="+stage+"&limit=10&asc=true";
	...
	Class.get = function(url, errorHandler) {
		var xreq = new XMLHttpRequest();
		xreq.open("GET", url, false);
		return send(xreq);
	}
