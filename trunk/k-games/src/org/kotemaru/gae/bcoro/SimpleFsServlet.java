...
public class SimpleFsServlet extends HttpServlet {
	private StoredBeanService sbs = SBSFactory.getSimplefs();
	private StoredBeanService usbs = SBSFactory.getUser();
	...
	private void doGetDir(HttpServletRequest req, HttpServletResponse res)
		...
		while (ite.hasNext()) {
			...
			Date lastModified = (Date)e.getProperty("lastModified");
			...
			writer.write(",\"lastModified\":"+lastModified.getTime());
	...
	private String toRFC822(Date d) {
